...
PRODUCT_VENDOR_KERNEL_HEADERS += kernel/sony/msm8x60/include
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.hardware=qcom androidboot.selinux=disabled user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 vmalloc=400M
